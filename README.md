...
# Installation
`bigKRLS` is available on CRAN and currently requires R version 3.3.0 or later. Windows users should use RTools 3.3 or later. To use RStudio, Windows must use RStudio 1.1.129 or newer. `bigKRLS` is also under active development on GitHub. To install, use standard devtools syntax:
